...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, orderCommand> consumerFactory() {
        ...
        // Deserializer untuk JSON payload
        JsonDeserializer<orderCommand> deserializer = new JsonDeserializer<>(orderCommand.class);
        deserializer.addTrustedPackages("*"); // gunakan paket spesifik di production nanti
